...
Public Class frmParametrosPozoEstimadoBR
    Public v_oSorteo As New PgmSorteo
    Private oParProxPozoEstimado As New ParProxPozoEstimado



    Private Sub frmParametrosPozoEstimadoBR_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If oParProxPozoEstimado Is Nothing Then
                FileSystemHelper.Log("frmParametrosPozoEstimadoBR.Load: el getParProxPozoEstimado retornó Nothing!! Se cierra la pantalla de par prox sorteo.")
                ...
                Catch ex2 As Exception
                    FileSystemHelper.Log("frmParametrosPozoEstimadoBR.Load: Excepción al querer cerrar la pantalla en el load porque el get parametros devolvió Nothing!!" & ex2.Message)
                End Try
                Exit Sub
            Else
            ...
            txtCant_apuestas_estimadas.SelectAll()
            txtCant_apuestas_estimadas.Focus()
        Catch ex As Exception
            FileSystemHelper.Log("frmParametrosPozoEstimadoBR.Load: Excepción ->" & ex.Message & "<-")
            ...
            Try
                Me.Close()
            Catch ex2 As Exception
                FileSystemHelper.Log("frmParametrosPozoEstimadoBR.Load: Excepción al querer cerrar la pantalla en el load ->" & ex2.Message & "<-")
            End Try
        End Try
    End Sub
    ...
    Private Sub btnguardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnguardar.Click
        Try
            ...
            'Me.Close()
        Catch ex As Exception
            FileSystemHelper.Log("frmParametrosPozoEstimadoBR.btnguardar_Click - Excepción ->" & ex.Message & "<-")
    ...
    Private Sub txtCant_apuestas_estimadas_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCant_apuestas_estimadas.KeyPress
        Try
        ...
        End Try
    End Sub
    Private Sub txtPorc_var_apuestas_miercoles_domingos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPorc_var_apuestas_miercoles_domingos.KeyPress
        Try
            If e.KeyChar = Convert.ToChar(Keys.Return) Then
                e.Handled = True
        ...
        End Try
    End Sub
    Private Sub txtPorc_var_apuestas_domingos_miercoles_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPorc_var_apuestas_domingos_miercoles.KeyPress
        Try
            If e.KeyChar = Convert.ToChar(Keys.Return) Then
                e.Handled = True
                txtPorc_var_apuestas_domingos_miercoles.Focus()
        ...
        End Try
    End Sub
    Private Sub txtPorc_cant_apuesta_3_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPorc_cant_apuesta_3.KeyPress
        Try
            If e.KeyChar = Convert.ToChar(Keys.Return) Then
                e.Handled = True
        ...
        End Try
    End Sub
    Private Sub txtPorc_cant_apuesta_7_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtPorc_cant_apuesta_7.KeyPress
        Try
            If e.KeyChar = Convert.ToChar(Keys.Return) Then
                e.Handled = True
    ...
    Private Sub actualizarValoresEnPantalla()
        ...
        txtPorc_dist_rec_impo_1_4.Text = oParProxPozoEstimado.Porc_dist_rec_impo_1_4.ToString(CultureInfo.CreateSpecificCulture("es-AR")) ' SOLO BRINCO
    ...
    Private Sub asignarValoresDePantallaAlObj()
        ...
        getDecimal(txtPorc_dist_rec_impo_1_4.Text, oParProxPozoEstimado.Porc_dist_rec_impo_1_4)
    ...
    Private Function validarPorcentajes() As Boolean
        ...
        End If
        'txtPorc_var_apuestas_domingos_miercoles.Text
        If Not porcValido(lbldomingo.Text, txtPorc_var_apuestas_domingos_miercoles, True, True) Then
            Return False
        End If
        ' ''txtPorc_cant_apuesta_3.Text
        ...
        If Not porcValido(lblDistPorPre.Text & " de " & lblMod1.Text & " " & lblTercero.Text, txtPorc_dist_rec_impo_1_3) Then
            Return False
        End If
        'txtPorc_dist_rec_impo_1_4.Text
        If Not porcValido(lblDistPorPre.Text & " de " & lblMod1.Text & " " & lblTercero.Text, txtPorc_dist_rec_impo_1_4) Then
            Return False
        End If
        'txtPorc_dist_rec_impo_1_esti.Text
    ...
    Private Sub actualizarApuestas()
        ...
        If txtCant_apuestas_estimadas.Text.Trim = "0" Or txtCant_apuestas_estimadas.Text.Trim = "" Then
            If ((Me.v_oSorteo.idJuego = 4) And (v_oSorteo.fechaHora.ToString("ddd").ToUpper() = "WED" OrElse v_oSorteo.fechaHora.ToString("ddd").ToUpper() = "MIE")) Or Me.v_oSorteo.idJuego = 13 Then
    ...
    Private Sub txtCant_apuestas_estimadas_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCant_apuestas_estimadas.LostFocus
        actualizarApuestas()
    End Sub

    Private Sub txtPorc_cant_apuesta_3_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPorc_cant_apuesta_3.LostFocus
        actualizarApuestas()
    End Sub

    Private Sub txtPorc_cant_apuesta_3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPorc_cant_apuesta_3.TextChanged
        actualizarApuestas()
    End Sub

    Private Sub txtCant_apuestas_estimadas_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCant_apuestas_estimadas.TextChanged
        actualizarApuestas()
    End Sub

    Private Sub txtPorc_cant_apuesta_7_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPorc_cant_apuesta_7.TextChanged
        actualizarApuestas()
    End Sub
