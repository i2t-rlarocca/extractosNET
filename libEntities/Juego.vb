Namespace Entities
    ...
    Public Class Juego
        ...
        Private _GeneraExtractoUnif As Boolean
        Private _FtpExtractoUnif As Boolean
        ...
        Public Property RedondeoPozoProxSorteo() As Long
            ...
            End Set
        End Property
        Public Property GeneraExtractoUnif() As Boolean
            Get
                Return _GeneraExtractoUnif
            End Get
            Set(ByVal value As Boolean)
                _GeneraExtractoUnif = value
            End Set
        End Property
        Public Property FtpExtractoUnif() As Boolean
            Get
                Return _FtpExtractoUnif
            End Get
            Set(ByVal value As Boolean)
                _FtpExtractoUnif = value
            End Set
        End Property
